...
const page = () => {
  ...
  return (
    <div className=" z-40 ">
      <header className=' pt-20 pb-12 bg-[url("/hero_mobile.svg")]   lg:bg-auto lg:bg-[url("/Hero-bg.png")]  bg-no-repeat min-h-[100px]  lg:pb-4 flex items-center flex-col lg:pt-64 mx-auto 2xl:bg-cover '>
        ...
        <h3 className="font-sentient  px-6 text-center text-[36px] font-medium italic leading-[44.68px] pb-6 text-white lg:max-w-[850px] lg:font-semibold lg:text-6xl">
          For donations, partnership & further enquiries
        </h3>
      </header>
      <section className='pt-16 lg:pt-32 min-w-full bg-[url("/focus_mobile.svg")] lg:bg-[url("/focus.svg")] bg-cover  bg-no-repeat min-h-[300px]  px-4  pb-16 lg:pb-32'>
        <p className="font-aventa_Semibold lg:text-[32px] text-center">
          Send us a message
        </p>
        <h3 className="font-aventa_Medium mt-3 mb-6 text-[20px] text-center">
          ...
          <div className=" flex gap-5 flex-col justify-between lg:flex-row">
            <div className="p-5 flex lg:w-3/5 border-[#DCDCDC] rounded-3xl border">
              ...
              <article className=" font-aventa_Light">
                ...
                <p className="">
                  42th Elekuku Idera Behind Trumed Chemist, off Adeoyo Hospital
