    ...
    <>
      <div>
        <video
          ...
          className="absolute top-[24rem] md:top-[20rem] lg:top-[110vh] left-1/2 transform -translate-x-1/2  border-4 border-[#EAE5D3] rounded-xl   w-[300px]  lg:w-[800px]"
          height="440"
        >
      ...
      <section className='bg-[url("/focus_mobile.svg")] lg:bg-[url("/focus.svg")] bg-cover lg:bg-cover bg-no-repeat min-h-[1000px]  pt-[12em] lg:pt-[18em]  mt-[-4em] z-50 pb-[8em]'>
        <section className="px-2 lg:px-0 lg:w-[80%] text-center lg:mx-auto font-normal text-[20px] lg:text-[30px] leading-[28.6px] lg:leading-[42.9px] trailing-[-2%]">
          ...
          <span className="font-aventa">
            {" "}
            is a non-profit organization dedicated to creating positive change
            and improving lives across Africa & beyond
          </span>
        </section>
